...
full_command_args = sys.argv
print("Full Command Args:")
print(full_command_args)

argument_list = full_command_args[1:]
print("Args List:")
print(argument_list)

exit()

MODEL_FILENAME = "./models/classifier_ALLFILES_100trees_ALLsigmas.model"
